...
class InceptionNet(nn.Module):
    def __init__(self, num_classes=51):
        ...
        self.Gloavgpool = nn.AdaptiveAvgPool2d(output_size = 1)
				...
				#self.st_3b = SpatialTransformBlock_DY(num_classes, 32, 256*3)
        #self.st_4b = SpatialTransformBlock_DY(num_classes, 16, 256*2)
        #self.st_5b = SpatialTransformBlock_DY(num_classes, 8, 256)
        
        self.st_3b = SpatialTransformBlock_DY(num_classes, 32, 256)
        self.st_4b = SpatialTransformBlock_DY(num_classes, 16, 256)
        self.st_5b = SpatialTransformBlock_DY(num_classes, 8, 256)
    ...
    def forward(self, input):
        ...
        return pred_3b, pred_4b, pred_5b, main_pred
...
class SpatialTransformBlock_DY(nn.Module):
    def __init__(self, num_classes, pooling_size, channels):
        ...
        for i in range(self.num_classes):
            ...
            self.fc_list.append(nn.Linear(2*channels, 1))     #### modify channels
            self.att_list.append(ChannelAttn_DY(channels))
            
            self.stn_list.append(nn.Linear(2*channels, 4))     ####### modify channels
    ...
    def forward(self, features,w_dy):
        ...
        for i in range(self.num_classes):
            ...
            stn_feature = self.att_list[i](features,w_dy)
            ...
            pred_list.append(pred)     ### one pre for one class
